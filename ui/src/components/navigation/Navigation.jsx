...
function Navigation(props) {
                ...
                ? (
                    ...
                    <React.Fragment>
                        ...
                        <ResponsiveLayout
                            ...
                            renderDesktop={() => (
                                <React.Fragment>
                                    <div onClick={() => handleRedirect(PAGES.dashboard)} className="menu-item outlined">Go to Map</div>
                                    <Dropdown drop={'left'}>
                                        <Dropdown.Toggle as={CustomToggle} id="dropdown-custom-components" />
                                        <Dropdown.Menu>
                                            <Dropdown.Item onClick={() => handleRedirect(PAGES.user)}>My Profile</Dropdown.Item>
                                            <Dropdown.Item onClick={() => handleRedirect(PAGES.scoreboard)}>Scoreboard</Dropdown.Item>
                            ...
                            renderMobile={() => (
                                <React.Fragment>
                                    <Nav.Link onClick={() => handleRedirect(PAGES.dashboard)}>Go to Map</Nav.Link>
    ...
    return (
        <Navbar variant="dark" expand="lg">
            <div onClick={() => handleRedirect(PAGES.landingPage)} className="brand-name">Snow<span>Hub</span></div>
